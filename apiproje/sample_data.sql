...
-- 9. Contact Tablosu (İletişim mesajları)
INSERT INTO Contacts (Name, Mail, Subject, Message, Date) VALUES
(N'Ali Veli', N'ali@gmail.com', N'Rezervasyon Hakkında', N'Merhaba, rezervasyon yapmak istiyorum. Müsait tarihler hakkında bilgi alabilir miyim?', GETDATE()),
(N'Fatma Öztürk', N'fatma@hotmail.com', N'Spa Hizmetleri', N'Spa hizmetleriniz hakkında detaylı bilgi almak istiyorum. Fiyat listesi var mı?', GETDATE()),
(N'Emre Yılmaz', N'emre@yahoo.com', N'Toplantı Salonu', N'50 kişilik toplantı için salon kiralaması yapmak istiyorum. Teklifinizi bekliyorum.', GETDATE()),
(N'Sibel Korkmaz', N'sibel@gmail.com', N'Düğün Organizasyonu', N'Düğün organizasyonu için otel hizmetlerinizi değerlendiriyoruz. Görüşebilir miyiz?', GETDATE()),
(N'Murat Aslan', N'murat@outlook.com', N'Grup Rezervasyonu', N'20 kişilik grup için toplu rezervasyon yapmak istiyorum. İndirim var mı?', GETDATE());

-- 10. MessageCategory Tablosu
